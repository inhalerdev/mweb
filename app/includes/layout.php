...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="stylesheet" href="assets/styles.css?v=bansfull3.8.27.277.266.255.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2">';
    echo '<link rel="stylesheet" href="assets/bans-modal-single.css?v=banssingle3.8.74">';
    echo '</head>';
}
...
function mineacle_footer(): void {
    ...
    echo '<script src="assets/main.js?v=bansfull3.8.27.277.266.255.244.233.222.211.200.199.188.177.166.144.8.7.6.5.4.3.2"></script>';
    echo '<script src="assets/bans-modal-single.js?v=banssingle3.8.74"></script>';
}
