...
function mineacle_page_head(string $title = 'Home'): void
{
    ...
    echo '<link rel="icon" type="image/png" href="/assets/fav.png?v=base28">';
    echo '<link rel="stylesheet" href="/assets/home-page.css?v=base28">';
    echo '</head>';
    echo '<body>';
}
...
{
    echo '<script src="/assets/home-page.js?v=base28"></script>';
    echo '</body>';
    echo '</html>';
}
