...
function mineacle_page_head(string $title): void {
    ...
    echo '<link rel="stylesheet" href="assets/bans-buttons-glass-cleanup.css?v=bansclean1.0.1">';
    echo '</head>';
    echo '<body>';
}
...
function mineacle_footer(): void {
    ...
    echo '<img src="assets/m-studios-logo-tight.png?v=bansclean1.0.10" alt="Mineacle Studios">';
    echo '</div>';
    echo '<h2>Mineacle</h2>';
