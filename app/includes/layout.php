...
function mineacle_page_head(string $title): void {
    ...
    $version = 'bansfull3.8.49-hero-overlay-spacing-fade';
...
function mineacle_header(string $active = 'bans'): void {
    ...
    echo '<img src="assets/mineacle-bans-hero-logo.png?v=bansfull3.8.49-hero-overlay-spacing-fade" alt="Mineacle Bans">';
    echo '</a>';

    echo '<a class="mcx-discord" href="' . $discord . '" target="_blank" rel="noopener" aria-label="Join Discord">';
    echo '<img src="assets/discord.svg?v=bansfull3.8.49-hero-overlay-spacing-fade" alt="">';
    echo '</a>';
    ...
    echo '<a class="mcx-mobile-item mcx-mobile-discord" href="' . $discord . '" target="_blank" rel="noopener"><img src="assets/discord.svg?v=bansfull3.8.49-hero-overlay-spacing-fade" alt=""><span>Discord</span></a>';
    echo '</div>';
    echo '</nav>';
